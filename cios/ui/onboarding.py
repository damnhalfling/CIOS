"""Onboarding Wizard — first-run setup for CIOS.
...
Runs automatically on first launch (no ~/.cios/settings.json).
Can be re-triggered with `cios --setup`.
"""
...
class OnboardingWizard:
    ...
    def _run_cli(self) -> bool:
        ...
        config.save()
        mark_onboarding_done()
        print("\n  ✓ Configuração salva! Iniciando CIOS...\n")
        return True
