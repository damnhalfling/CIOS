...
_ALIASES: dict[str, list[str]] = {
    ...
    "bash": ["footclient", "foot", "gnome-terminal", "xterm", "konsole", "alacritty", "kitty"],
    "shell": ["footclient", "foot", "gnome-terminal", "xterm", "konsole", "alacritty", "kitty"],
    "console": ["footclient", "foot", "gnome-terminal", "xterm", "konsole", "alacritty", "kitty"],
