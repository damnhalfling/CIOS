...
_ALIASES: dict[str, list[str]] = {
    ...
    "bash": ["foot", "footclient", "gnome-terminal", "xterm", "konsole", "alacritty", "kitty"],
    "shell": ["foot", "footclient", "gnome-terminal", "xterm", "konsole", "alacritty", "kitty"],
    "console": ["foot", "footclient", "gnome-terminal", "xterm", "konsole", "alacritty", "kitty"],
