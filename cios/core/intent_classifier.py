...
_DB_PATH = CIOS_HOME / "intent_cache.db"
...
_CLASSIFY_SYSTEM = (
    "You are an intent classifier for CIOS, a voice-controlled Linux desktop.\n"
    ...
    "- self_update: check/install CIOS updates (params: action)\n"
...
_KNOWLEDGE_PATTERNS = re.compile(
    ...
    r"(?:me\s+)?explic[ae]|"  # "me explica", "explica"
    ...
    r"(?:can\s+you\s+)?explain|"  # "explain", "can you explain"
    r"why\s+|"  # "why"
