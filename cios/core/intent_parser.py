...
_CONTEXT_WORDS: dict[IntentType, set[str]] = {
    IntentType.AUDIO: {
        "volume", "som", "áudio", "audio", "música", "musica", "music",
        "alto", "baixo", "mudo", "mute", "speaker", "caixa", "fone",
        "headphone", "sound", "alto-falante", "silenciar",
    },
    IntentType.APP_LAUNCH: {
        "abra", "abre", "abrir", "open", "launch", "inicia", "iniciar",
        "inicializar", "roda", "rodar", "executa", "executar", "start",
        "abrindo", "programa", "aplicativo", "app",
    },
    IntentType.SESSION: {
        "desligar", "desliga", "reiniciar", "reinicia", "reboot",
        "shutdown", "logout", "sair", "logoff", "power",
        "bloquear", "bloqueia", "lock", "suspender", "suspend",
        "hibernate", "hibernar", "restart",
        "computador", "máquina", "maquina", "sistema", "pc", "off",
    },
    IntentType.NETWORK: {
        "wifi", "wi-fi", "rede", "redes", "network", "networks",
        "internet", "conectar", "conecta", "conectado",
        "ip", "dns", "vpn", "ethernet", "conexão", "conexao",
        "ssid", "roteador", "router", "ping", "listar",
        "show", "scan", "disponíveis", "disponiveis",
    },
    IntentType.MEDIA_PLAY: {
        "toca", "tocar", "play", "reproduzir", "reproduza",
        "música", "musica", "music", "song", "playlist",
        "ouvir", "escutar", "coloca", "bota",
    },
    IntentType.MEDIA_CONTROL: {
        "próxima", "proxima", "next", "anterior", "previous", "prev",
        "pausa", "pause", "para", "stop", "player", "reprodução",
        "reproduzindo", "tocando", "playing", "faixa", "track",
    },
    IntentType.PACKAGE: {
        "instalar", "instala", "install", "desinstalar", "remover",
        "remove", "pacote", "package", "apt", "programa", "software",
        "deb", "dpkg", "snap", "flatpak",
    },
    IntentType.PROCESS_CONTROL: {
        "processo", "process", "pid", "kill", "matar", "mata",
        "travado", "travou", "engasgado", "consumindo", "cpu",
        "memória", "memoria", "ram", "porta", "port",
    },
    IntentType.POWER: {
        "bateria", "battery", "energia", "power", "suspender",
        "suspend", "hibernar", "brilho", "brightness",
        "carregar", "carregando", "desligar", "computador",
        "economia", "saving", "modo",
    },
    IntentType.DISK_ANALYSIS: {
        "disco", "disk", "espaço", "space", "storage",
        "armazenamento", "hd", "ssd", "partição", "partition",
        "livre", "free", "ocupado", "used", "gb", "tb",
        "limpar", "clean", "cache", "lixo", "tmp",
    },
    IntentType.WINDOW: {
        "janela", "window", "minimizar", "minimize", "maximizar",
        "maximize", "fechar", "close", "tela", "mover",
        "redimensionar", "resize", "lado", "esquerda", "direita",
    },
    IntentType.FILE_ORGANIZE: {
        "organizar", "organize", "mover", "move", "arquivo", "file",
        "pasta", "folder", "downloads", "documentos", "documents",
        "ordenar", "sort", "limpar", "clean", "arrumar",
        "área", "area", "trabalho", "desktop", "bagunça",
    },
    IntentType.CLIPBOARD: {
        "copiar", "colar", "copy", "paste", "clipboard",
        "área de transferência", "ctrl+c", "ctrl+v", "histórico",
    },
    IntentType.INTENT_MEDIA: {
        "foto", "fotos", "photo", "photos", "imagem", "imagens",
        "image", "vídeo", "video", "galeria", "gallery",
        "mídia", "media", "álbum", "album",
    },
    IntentType.BLUETOOTH: {
        "bluetooth", "bt", "pareamento", "parear", "pair",
        "fone", "headset", "caixa", "dispositivo", "device",
    },
}
