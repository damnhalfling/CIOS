...
_PT_MAP: dict[str, str] = {
    ...
    "Checking volume…": "Verificando volume…",
    ...
    # Package management
    "installed successfully": "instalado",
    "is already installed": "já está instalado",
    "removed successfully": "removido",
    "is not installed": "não está instalado",
    "Package lists updated successfully": "Listas de pacotes atualizadas",
