"""Skill: explore_system — show what Harmoni can do.
...
from harmoni.skills.app_launcher import get_installed_apps
...
_CAPABILITIES: list[Capability] = [
    ...
    Capability(
        ...
        description_pt="Controle por voz: fale e o Harmoni executa",
        description_en="Voice control: speak and Harmoni executes",
    ),
]
