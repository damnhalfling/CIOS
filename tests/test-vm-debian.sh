...
#
#  Usage:
#    bash tests/test-vm-debian.sh [DEB_FILE]
#
...
# ── Start VM ──
echo "  [1/5] Starting Debian 12 VM..."
cd "$VAGRANT_DIR"
...
echo "  ═══════════════════════════════════════"
if [ $FAIL -eq 0 ]; then
    echo -e "  ${GREEN}✓ All $TOTAL checks passed (Debian 12)${NC}"
else
    echo -e "  ${RED}✗ $FAIL/$TOTAL checks failed (Debian 12)${NC}"
fi
echo "  ═══════════════════════════════════════"
echo ""
